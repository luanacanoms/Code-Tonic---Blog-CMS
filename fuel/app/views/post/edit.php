...
<?php echo Form::open('/posts/edit/' . $post->id); ?>
    ...
    <div class="form-group">
        ...
        <?php echo Form::select('category', Input::post('category', isset($post) ? $post->category : '0'), array(
    ...
    <br>
    <div class="actions">
        <?php echo Form::submit('send', 'Actualizar Post', array('class' => 'btn btn-primary')); ?>
    </div>
